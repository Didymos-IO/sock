...
const ChatDots = (props: IconProps) => {
...
const ChatLeftQuote = (props: IconProps) => {
  const { isActive } = props;
...
const ChatLeftText = (props: IconProps) => {
  const { isActive } = props;
...
const Power = () => {
  return (
    <svg
      ...
      height="20"
      fill="currentColor"
      className="bi bi-power me-1 mt-n1 align-middle"
      viewBox="0 0 16 16"
    >
...
const Terminal = (props: IconProps) => {
  const { isActive } = props;
